...
const PinMap PinMap_ADC[] = {
    {PE_0, ADC_0, SYS_GPE_MFPL_PE0MFP_ADC0_0},  // ADC0_0
    {PE_1, ADC_0, SYS_GPE_MFPL_PE1MFP_ADC0_1},  // ADC0_1
    {PE_2, ADC_0, SYS_GPE_MFPL_PE2MFP_ADC0_2},  // ADC0_2
    {PE_3, ADC_0, SYS_GPE_MFPL_PE3MFP_ADC0_3},  // ADC0_3
    {PE_4, ADC_0, SYS_GPE_MFPL_PE4MFP_ADC0_4},  // ADC0_4
    {PE_5, ADC_0, SYS_GPE_MFPL_PE5MFP_ADC0_5},  // ADC0_5
    {PE_6, ADC_0, SYS_GPE_MFPL_PE6MFP_ADC0_6},  // ADC0_6
    {PE_7, ADC_0, SYS_GPE_MFPL_PE7MFP_ADC0_7},  // ADC0_7
    
    {PE_8, ADC_1, SYS_GPE_MFPH_PE8MFP_ADC1_0},  // ADC1_0
    {PE_9, ADC_1, SYS_GPE_MFPH_PE9MFP_ADC1_1},  // ADC1_1
    {PE_10, ADC_1, SYS_GPE_MFPH_PE10MFP_ADC1_2},  // ADC1_2
    {PE_11, ADC_1, SYS_GPE_MFPH_PE11MFP_ADC1_3},  // ADC1_3
    {PE_12, ADC_1, SYS_GPE_MFPH_PE12MFP_ADC1_4},  // ADC1_4
    {PE_13, ADC_1, SYS_GPE_MFPH_PE13MFP_ADC1_5},  // ADC1_5
    {PE_14, ADC_1, SYS_GPE_MFPH_PE14MFP_ADC1_6},  // ADC1_6
    {PE_15, ADC_1, SYS_GPE_MFPH_PE15MFP_ADC1_7},  // ADC1_7
...
const PinMap PinMap_PWM[] = {
    {PA_5, PWM_0, SYS_GPA_MFPL_PA5MFP_PWM0_CH0},
    {PA_6, PWM_0, SYS_GPA_MFPL_PA6MFP_PWM0_CH1},
    {PA_7, PWM_1, SYS_GPA_MFPL_PA7MFP_PWM1_CH3},
    //{PA_7, EPWM_0, SYS_GPA_MFPL_PA7MFP_EPWM0_CH5},
    //{PA_7, EPWM_0, SYS_GPA_MFPL_PA7MFP_EPWM0_CH5},
    {PA_8, PWM_1, SYS_GPA_MFPH_PA8MFP_PWM1_CH2},
    //{PA_8, EPWM_0, SYS_GPA_MFPH_PA8MFP_EPWM0_CH4},
    {PA_9, PWM_1, SYS_GPA_MFPH_PA9MFP_PWM1_CH1},
    //{PA_9, EPWM_0, SYS_GPA_MFPH_PA9MFP_EPWM0_CH3},
    {PA_10, PWM_1, SYS_GPA_MFPH_PA10MFP_PWM1_CH0},
    //{PA_10, EPWM_0, SYS_GPA_MFPH_PA10MFP_EPWM0_CH2},
    {PA_11, PWM_0, SYS_GPA_MFPH_PA11MFP_PWM0_CH5},
    //{PA_11, EPWM_0, SYS_GPA_MFPH_PA11MFP_EPWM0_CH1},
    {PA_12, PWM_0, SYS_GPA_MFPH_PA12MFP_PWM0_CH4},
    //{PA_12, EPWM_0, SYS_GPA_MFPH_PA12MFP_EPWM0_CH0},
    {PA_13, PWM_1, SYS_GPA_MFPH_PA13MFP_PWM1_CH4},
    {PA_14, PWM_1, SYS_GPA_MFPH_PA14MFP_PWM1_CH5},
    {PB_6, PWM_1, SYS_GPB_MFPL_PB6MFP_PWM1_CH4},
    //{PB_6, EPWM_1, SYS_GPB_MFPL_PB6MFP_EPWM1_CH0},
    {PB_7, PWM_1, SYS_GPB_MFPL_PB7MFP_PWM1_CH5},
    ...
    {PC_10, PWM_0, SYS_GPC_MFPH_PC10MFP_PWM0_CH2},
    {PC_11, PWM_0, SYS_GPC_MFPH_PC11MFP_PWM0_CH3},
    {PF_9, PWM_0, SYS_GPF_MFPH_PF9MFP_PWM0_CH0},
    {PF_10, PWM_0, SYS_GPF_MFPH_PF10MFP_PWM0_CH1},
